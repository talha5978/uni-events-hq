...
export const meta = () => {
	return [
		{
			title: "President Dashboard | Student Portal",
		},
	];
};
				...
				<Card className="relative overflow-hidden border-border/60 bg-card hover:border-purple-500/30 hover:shadow-md transition-all duration-200">
					<CardContent className="p-5 sm:p-6">
						...
						<div className="flex items-baseline justify-between">
							...
							<span className="text-xs text-muted-foreground font-medium">Active Enrolled</span>
						</div>
					</CardContent>
				</Card>
											...
											>
												...
												<TableCell className="text-right pr-6">
													<Button
														...
														asChild
													>
														<Link to={`/treasurer/verify/${reg.registrationId}`}>
															Verify
